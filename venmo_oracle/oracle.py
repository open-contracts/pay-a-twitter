...
with opencontracts.enclave_backend() as enclave:
  ...
  hash = bytes(0) # enclave.keccack(seller, amount, message, secret, types=('string', 'uint256', 'string', 'string'))
  enclave.print(f"You are about to accept the offer with the offerHash {'0x' + hash.hex()}.")
  enclave.print("Call the ethOffered() function to verify that you will receive enough ETH before paying the seller.")
