...
with opencontracts.enclave_backend() as enclave:
  ...
  #hash = enclave.keccack(seller, amount, message, secret, types=('string', 'uint256', 'string', 'string'))
  #enclave.print(f"If successful, you would receive the hash {'0x' + hash.hex()}. Call the EthForHash() function to verify that you will receive enough ETH before paying the seller.")
  ...
  enclave.print(get_most_recent_tx(mhtml))
  hash = bytes(0)
